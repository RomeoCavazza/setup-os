...
in
{
  ...
  xdg.dataFile."icons/hicolor/256x256/apps/antigravity-icon.png".source = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/RomeoCavazza/assets/main/nixos-config/config/icons/hicolor/256x256/apps/antigravity-icon.png";
  ...
  xdg.dataFile."icons/hicolor/512x512/apps/antigravity-icon.png".source = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/RomeoCavazza/assets/main/nixos-config/config/icons/hicolor/512x512/apps/antigravity-icon.png";
  ...
  xdg.dataFile."icons/hicolor/256x256/apps/cursor-icon.png".source = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/RomeoCavazza/assets/main/nixos-config/config/icons/hicolor/256x256/apps/cursor-icon.png";
  ...
  xdg.dataFile."icons/hicolor/512x512/apps/cursor-icon.png".source = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/RomeoCavazza/assets/main/nixos-config/config/icons/hicolor/512x512/apps/cursor-icon.png";
