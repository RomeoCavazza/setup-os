...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#0E7490', 'secondaryColor': '#0E7490', 'tertiaryColor': '#0E7490', 'primaryBorderColor': '#888', 'lineColor': '#888', 'primaryTextColor': '#eee' }}}%%
flowchart LR
  inputs[Flake inputs]
  flake[flake.nix]
  system[System layer]
